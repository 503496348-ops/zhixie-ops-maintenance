# 产品融合增强执行清单
生成时间：2026-07-23T11:29:25.696134
...
### 2. AIPMAndy/dna-memory
- 分类：智能体上下文
- 映射产品：hermes-doctor, pipixia-doctor, mindriver, neverend
- 融合判定：可融合候选
- 评分：8（状态：pending_review）
- 审计信号：total=9.1, tech=8
- 缺口特征：无明显缺口
- 执行证据：
  - AIPMAndy/dna-memory status=可融合候选 score=8
...
### 4. code2rich/agentwaker-wechat-official-account-operator
- 分类：内容创作
- 映射产品：artipen
- 融合判定：可融合候选
- 评分：7（状态：recorded）
...
### 11. beautiful-feishu-whiteboard
- 分类：飞书白板设计+PPT
- 映射产品：nichecraft
- 融合判定：可融合候选
- 评分：5（状态：implemented）
...
- 执行证据：
  - NeuraSea/agentic-ocr status=仅记录 score=2
  - products=[]

### 20. vrtmrz/obsidian-livesync
- 分类：知识管理
- 映射产品：neverend
- 融合判定：观察/人工复核
- 评分：1（状态：watching）
...
### 22. Auriti-Labs/geo-optimizer-skill
- 分类：GEO诊断
- 映射产品：minddistill
- 融合判定：观察/人工复核
- 评分：1（状态：watching）
...
### 25. linuxserver/docker-obsidian
- 分类：知识管理
- 映射产品：neverend
- 融合判定：仅记录
- 评分：-5（状态：recorded）
...
### 26. aaron-he-zhu/seo-geo-claude-skills
- 分类：GEO诊断
- 映射产品：minddistill
- 融合判定：仅记录
- 评分：-5（状态：recorded）
...
### 28. zubair-trabzada/geo-seo-claude
- 分类：GEO诊断
- 映射产品：minddistill
- 融合判定：仅记录
- 评分：-5（状态：recorded）
